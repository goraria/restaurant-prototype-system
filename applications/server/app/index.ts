// Quan trọng: Import và đăng ký module-alias ĐẦU TIÊN cho production build
...
import { connectDB } from '@config/database'; // Sử dụng alias
import apiRoutes from '@routes/userRoutesNew'; // Sử dụng alias
