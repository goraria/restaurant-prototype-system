        ...
        {filteredChats.length > 0 ? (
          <View>
            {filteredChats.map((chat, index) => (
              <View key={index} className="flex-row items-center border-y gap-3 p-3">
                <View className="relative">
                  ...
                  />
                  {chat.isOnline && (
                    <View className="absolute -bottom-1 -right-1 h-4 w-4 rounded-full border-2 border-background bg-green-500" />
                  )}
                </View>
                ...
                <View className="flex-1">
                  ...
                  <View className="flex-row items-center gap-2">
                    ...
                    />
                    <Text
                      className="text-sm text-muted-foreground text-start w-32"
                      numberOfLines={1}
                    >
                      {chat.time}
                    </Text>
                ...
                <View>
                  ...
                  {chat.unreadCount > 0 ? (
                    ...
                    <Badge className="bg-background size-10 rounded-full">
                      <View
